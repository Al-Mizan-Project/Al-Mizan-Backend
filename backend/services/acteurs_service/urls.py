...
urlpatterns = [
    ...
    path("acteurs/services-contractants", ServiceContractantListCreateView.as_view()),
    path("acteurs/services-contractants/<int:service_id>", ServiceContractantRetrieveUpdateDeleteView.as_view()),
    path("acteurs/services-contractants/<int:service_id>/membres", ServiceContractantMembresView.as_view()),
