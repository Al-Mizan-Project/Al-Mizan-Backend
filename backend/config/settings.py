...
REMOTE_SERVICE_TIMEOUT = env_float("REMOTE_SERVICE_TIMEOUT", 3.0)
...
GEMINI_MAX_TOKENS = env_int("GEMINI_MAX_TOKENS", 2000)
REMOTE_SERVICE_TIMEOUT_IA = env_float("REMOTE_SERVICE_TIMEOUT_IA", 60.0)
GEMINI_MAX_RETRIES = env_int("GEMINI_MAX_RETRIES", 2)
GEMINI_RETRY_BASE_DELAY = env_float("GEMINI_RETRY_BASE_DELAY", 10.0)