...
# ---------------------------------------------------------------------------
DB_NAME = env_str("DB_NAME", "evaluations_db")
DB_USER = env_str("DB_USER", "evaluations_user")
DB_PASSWORD = env_str("DB_PASSWORD", "evaluations_password")
DB_HOST = env_str("DB_HOST", "pgbouncer_evaluations")
...
# Redis / Cache
# ---------------------------------------------------------------------------
REDIS_URL = env_str("REDIS_URL", "redis://redis_evaluations:6379/1")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Al-Mizan Evaluations Service API",
    "VERSION": "1.0.0",
}
...
# ---------------------------------------------------------------------------
CONTRATS_SERVICE_URL = env_str("CONTRATS_SERVICE_URL", "http://contrats_api:8000")
