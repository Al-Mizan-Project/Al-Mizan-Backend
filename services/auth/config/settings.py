...
DB_NAME = env_str("DB_NAME", "auth_db")
DB_USER = env_str("DB_USER", "auth_user")
DB_PASSWORD = env_str("DB_PASSWORD", "auth_password")
DB_HOST = env_str("DB_HOST", "pgbouncer_auth")
...
REDIS_URL = env_str("REDIS_URL", "redis://redis_auth:6379/1")
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "auth_login": os.getenv("THROTTLE_AUTH_LOGIN_RATE", "20/minute"),
        "auth_password_reset": os.getenv("THROTTLE_AUTH_PASSWORD_RESET_RATE", "20/minute"),
    },
}

SPECTACULAR_SETTINGS = {
    "TITLE": "Al-Mizan Auth Service API",
    "VERSION": "1.0.0",
}
...
MEMBRES_SERVICE_URL = env_str("MEMBRES_SERVICE_URL", "")
MEMBRES_SERVICE_TIMEOUT = float(os.getenv("MEMBRES_SERVICE_TIMEOUT", "3"))
