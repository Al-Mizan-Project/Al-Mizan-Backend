...
DB_NAME = env_str("DB_NAME", "acteurs_db")
DB_USER = env_str("DB_USER", "acteurs_user")
DB_PASSWORD = env_str("DB_PASSWORD", "acteurs_password")
DB_HOST = env_str("DB_HOST", "pgbouncer_acteurs")
...
REDIS_URL = env_str("REDIS_URL", "redis://redis_acteurs:6379/1")
