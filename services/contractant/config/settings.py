...
DB_NAME = env_str("DB_NAME", "contractant_db")
DB_USER = env_str("DB_USER", "contractant_user")
DB_PASSWORD = env_str("DB_PASSWORD", "contractant_password")
DB_HOST = env_str("DB_HOST", "pgbouncer_contractant")
...
_redis_default = (
    f"redis://:{REDIS_PASSWORD}@redis_contractant:6379/1"
    if REDIS_PASSWORD
    else "redis://redis_contractant:6379/1"
)
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "contractant_write": os.getenv("THROTTLE_CONTRACTANT_WRITE_RATE", "90/minute"),
    },
}

SPECTACULAR_SETTINGS = {
    "TITLE": "Al-Mizan Contractant Service API",
    "VERSION": "1.0.0",
}
...
ACTEURS_SERVICE_TIMEOUT = float(os.getenv("ACTEURS_SERVICE_TIMEOUT", "3"))
