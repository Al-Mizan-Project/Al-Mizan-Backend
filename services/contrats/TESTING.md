...
### View OpenAPI Spec
```ash
curl http://localhost:18085/openapi.json | jq
```

### Check Database Tables
```ash
# Connect to shared PostgreSQL
docker exec -it almizan_shared_postgres psql -U contrats_user -d contrats_db
...
### Port 18085 already in use
```ash
# Change CONTRATS_NGINX_PORT in .env
CONTRATS_NGINX_PORT=18090
```
