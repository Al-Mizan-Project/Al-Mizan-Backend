...
class ValidationListCreateView(ListCreateAPIView):
    permission_classes = [AllowAny]
...
class ValidationRetrieveUpdateDeleteView(RetrieveUpdateDestroyAPIView):
    permission_classes = [AllowAny]
...
class ContratListCreateView(ListCreateAPIView):
    permission_classes = [AllowAny]
...
class ContratRetrieveUpdateDeleteView(RetrieveUpdateDestroyAPIView):
    permission_classes = [AllowAny]
...
class ContratDocumentsListView(APIView):
...
class ContratDocumentDetailView(APIView):
    """
...
class SoumissionContratView(APIView):
