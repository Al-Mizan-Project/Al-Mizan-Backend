...
### View OpenAPI Spec
```ash
curl http://localhost:18088/openapi.json | jq
```

### Check Database Tables
```ash
# Connect to shared PostgreSQL
docker exec -it almizan_shared_postgres psql -U ia_user -d ia_db
...
### Port 18088 already in use
```ash
# Change IA_NGINX_PORT in .env
IA_NGINX_PORT=18090
```
