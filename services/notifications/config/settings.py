...
# ---------------------------------------------------------------------------
DB_NAME = env_str("DB_NAME", "notifications_db")
DB_USER = env_str("DB_USER", "notifications_user")
DB_PASSWORD = env_str("DB_PASSWORD", "notifications_password")
DB_HOST = env_str("DB_HOST", "pgbouncer_notifications")
...
# Redis / Cache
# ---------------------------------------------------------------------------
REDIS_URL = env_str("REDIS_URL", "redis://redis_notifications:6379/1")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Al-Mizan Notifications Service API",
    "VERSION": "1.0.0",
}
