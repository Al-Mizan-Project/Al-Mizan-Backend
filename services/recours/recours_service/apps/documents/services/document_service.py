...
from recours.domain.entities.document_recours import DocumentRecours

from recours.infrastructure.models.document_recours_model import DocumentRecoursModel

from integrations.documents_client import DocumentsClient
