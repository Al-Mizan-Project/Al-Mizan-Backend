...
DB_NAME = env_str("DB_NAME", "appels_db")
DB_USER = env_str("DB_USER", "appels_user")
DB_PASSWORD = env_str("DB_PASSWORD", "appels_password")
DB_HOST = env_str("DB_HOST", "pgbouncer_appels")
...
_redis_default = (
    f"redis://:{REDIS_PASSWORD}@redis_appels:6379/1"
    if REDIS_PASSWORD
    else "redis://redis_appels:6379/1"
)
REDIS_URL = env_str("REDIS_URL", _redis_default)
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "appels_write": os.getenv("THROTTLE_APPELS_WRITE_RATE", "90/minute"),
    },
}

SPECTACULAR_SETTINGS = {
    "TITLE": "Al-Mizan Appels Service API",
    "VERSION": "1.0.0",
}
...
CONTRACTANT_SERVICE_TIMEOUT = float(os.getenv("CONTRACTANT_SERVICE_TIMEOUT", "3"))
DOCUMENTS_SERVICE_URL = env_str("DOCUMENTS_SERVICE_URL", "")
DOCUMENTS_SERVICE_TIMEOUT = float(os.getenv("DOCUMENTS_SERVICE_TIMEOUT", "3"))
